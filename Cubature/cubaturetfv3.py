...
debug = False
debug_mod = False
def cubature_int_f(func,t, mean, cov, return_cubature_points=False, cubature_points=None, u=None, sqr=False):
    """
   ...
   e.g.
    ...
    int_ = [func(cubature_point,t, u) for cubature_point in cubature_points]
