...
class PhysiologicalComponent(ABC):
    """ 
        PhysiologicalComponent: An abstract class, so some of the functions are implemented but some of them needs 
                                to be implemented by the extending class. Shouldnt be instantiated. All compatible 
                                classifiers must inherent from this class and implement the abstract methods.
    ...
    def set_constants(self):
        """ Sets all constants of the component """
