...
model.add(LSTM(units = 20,return_sequences=(True),input_shape=(window_size,ny)))
...
for i in range(epochs):
    ...
    for m in t_batch[:,1:].T:
        ...
        Sw=np.matmul(C_kw,np.matmul(Pw,C_kw.T)) + 1e2*Rw
